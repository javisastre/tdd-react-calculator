...
class Window extends EventTarget_1.default {
    ...
    constructor(options) {
        ...
        this.happyDOM = {
            ...
            setInnerWidth: (width) => {
                if (this.innerWidth !== width) {
                    ...
                    this.dispatchEvent(new Event_1.default('resize'));
                }
            },
        ...
        this.MediaQueryListEvent = MediaQueryListEvent_1.default;
        ...
        this.CSSRule = CSSRule_1.default;
        this.CSSContainerRule = CSSContainerRule_1.default;
        this.CSSFontFaceRule = CSSFontFaceRule_1.default;
        this.CSSKeyframeRule = CSSKeyframeRule_1.default;
        this.CSSKeyframesRule = CSSKeyframesRule_1.default;
        this.CSSMediaRule = CSSMediaRule_1.default;
        this.CSSStyleRule = CSSStyleRule_1.default;
    ...
    getComputedStyle(element) {
        return new CSSStyleDeclaration_1.default(element, true);
    }
    /**
     * Returns selection.
     *
    ...
    matchMedia(mediaQueryString) {
        return new MediaQueryList_1.default(this, mediaQueryString);
    }
    /**
